 ...
 * @LastEditTime: 2020-09-30 10:07:37
 */
#include <stdio.h>
#include <limits.h>
#include <float.h>
...
int main(void)
{
    ...
    print_Byte((unsigned char *)&uc_1Data, iSize);
    print_Byte((unsigned char *)&s_2Data, iSize);
    print_Byte((unsigned char *)&us_2Data, iSize);
    print_Byte((unsigned char *)&i_4Data, iSize);
    print_Byte((unsigned char *)&ui_4Data, iSize);
    print_Byte((unsigned char *)&l_4Data, iSize);
    print_Byte((unsigned char *)&ul_4Data, iSize);
    print_Byte((unsigned char *)&f_4Data, iSize);
    print_Byte((unsigned char *)&d_8Data, iSize);
